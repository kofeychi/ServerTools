package dev.kofeychi.manageable.common.render;

import dev.kofeychi.manageable.ManageableMain;
import dev.kofeychi.manageable.common.util.Color;
...
import static dev.kofeychi.manageable.common.render.TextureIds.TEXTURE_SHEET;
...
public enum GuiTexture {
    ...
    GUI_PANEL_SINGLE(4,4,1,1, ManageableMain.of("window")),

    GUI_TRANSPARENT(255,255,1,1, ManageableMain.of("window"));
